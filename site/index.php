  ...
  <body>    
    ...
    <section id="infinite" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="#infinite" class="navbar-brand">Universidad Nacional de San Martin</a>
          </div>             
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#whatwedo">This TP</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#gallery">Gallery</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#contact">Host</a>
              </li>                  
            </ul>
          </div>        
        </div>
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Linux Course</h2>
            <p class="tm-hero-subtitle">Practical Work </p>
    ...
    <section id="whatwedo" class="tm-section-pad-top">
      ...
      <div class="container">
            ...
            <div class="row tm-content-box"><!-- first row -->
                <div class="col-lg-12 col-xl-12">
                    <div class="tm-intro-text-container">
                        <h2 class="tm-text-primary mb-4 tm-section-title">This TP</h2>
                        <p class="mb-4 tm-intro-text">
                          WEB Apache Server creation, this has a customized page, it gather official Ubuntu, Debian or Fedora. In our case, Ubuntu image was selected.
						</p>
                    </div>
                </div>
            ...
            <div class="row tm-content-box"><!-- second row -->
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                        <h2 class="tm-text-primary mb-4">Docker</h2>
                        <p class="mb-4 tm-intro-text">
                          Docker is used to build a custom image, including Ubuntu Image and runing apt to install apache and php.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                        <h2 class="tm-text-primary mb-4">Swarm</h2>
                        <p class="mb-4 tm-intro-text">
                          We tried to configure Swarm as orchestator. If any successful configuration was made, this page should show it.</p>
                    </div>
                </div>
            ...
            <div class="row tm-content-box"><!-- third row -->
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                        <h2 class="tm-text-primary mb-4">Apache</h2>
                        <p class="mb-4 tm-intro-text">
                      Selected as a <strong>Web Server</strong> , for statical page, but in this case, plus php, it leaves a statical and serve a dinamical page.</p>
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                      <h2 class="tm-text-primary mb-4">PHP language</h2>
                        <p class="mb-4 tm-intro-text">
                     Some actions were made to show hostname and server name, buy default configuration, apache shows localhost or IP 127.0.0.1 </p>
        ...
        <div class="row">
          <div class="text-center col-12">
              ...
              <p class="mx-auto tm-section-desc">
                Some errors are presented in below gallery, only to reduce simplicity of the page, and agregating some interaction with visitors.
              </p>
          </div>            
        </div>
        <div class="row">
            <div class="col-12">
                <div class="mx-auto tm-gallery-container">
                    <div class="grid tm-gallery">
                      <a href="img/errors/errorCopyingFolder.png">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/errors/errorCopyingFolder.png" alt="Error 1" class="img-fluid">
                          <figcaption>
                            <h2><i>Copying Folder<span>#Error</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/errors/errorCreatingVolume.png">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/errors/errorCreatingVolume.png" alt="Image 2" class="img-fluid">
                          <figcaption>
                            <h2><i>Creating Volume <span>#error</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/errors/errorDoubleSpace.png">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/errors/errorDoubleSpace.png" alt="Image 3" class="img-fluid">
                          <figcaption>
                            <h2><i><span>Double Space</span> #Error</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/errors/errorRunBadCommand.png">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/errors/errorRunBadCommand.png" alt="Image 4" class="img-fluid">
                          <figcaption>
                            <h2><i>Run wrong command <span>#error</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/errors/errorDockerNotWorking.png">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/errors/errorDockerNotWorking.png" alt="Image 5" class="img-fluid">
                          <figcaption>
                            <h2><i><span>Docker doesn't work</span> #reinstall</i></h2>
                          </figcaption>
                        </figure>
                      </a>
	...
	<section id="contact" class="tm-section-pad-top tm-parallax-2">
      ...
      <div class="container tm-container-contact">
        ...
        <div class="row">
            ...
            <div class="text-center col-12">
                <h2 class="tm-section-title mb-4">Host</h2>
                <p class="mb-5">
                 If swarm is configured and httpd.conf is updated on each host, here it should be custom servername. 
				 <?php
					echo "Bienvenido, este es el nodo con server name ";
					echo $_SERVER['SERVER_NAME'];
					echo "<br> Y el HTTP Host ";
